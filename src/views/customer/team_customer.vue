<template>
  <div class="app-container">
    <div class="filter-container" style="margin-bottom: 5px;">
      ...
      <el-select v-model="listQuery.teamUserId" size="mini" clearable style="margin-left: 20px;width: 100px;" placeholder="请选择用户" @change="fetchData">
        <el-option
...
<script>
import { team, addCustomer, getTeamUser } from '@/api/customer'
